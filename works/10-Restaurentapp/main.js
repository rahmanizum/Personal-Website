...
await axios.post(`https://crudcrud.com/api/ee4fdb0b790548cca0f6291030775e8d/dishdata`, { dishdata })
  .then((res) => {
  ...
  axios.get(`https://crudcrud.com/api/ee4fdb0b790548cca0f6291030775e8d/dishdata`)
  .then((res) => { 
...
//remove from server 
axios
.delete(`https://crudcrud.com/api/ee4fdb0b790548cca0f6291030775e8d/dishdata/${btnId}`)
...
.get(`https://crudcrud.com/api/ee4fdb0b790548cca0f6291030775e8d/dishdata`)
.then((res) => { 
